...
<section>
	<div class="page-width--large">
		...
		<div class="grid grid--gutter flex-align-center">
			<div class="col-12@medium relative">
			...
			<div class="col-12@medium first-last">
				<div class="product__labels grid label text-pink margin-bottom-2">
					<span><?php  echo implode( ', ', $term_links ); ?></span>
					<span><?php echo $label; ?></span>
				</div>
				<h1 class="heading-2 margin-0"><?php echo $title; ?></h1>
				<div class="text-main">
					<?php echo $description; ?>
				</div>
				<a class="button margin-top-2" href="#">
					Enquire now
				...
				<div class="margin-top-5">
					<a href="<?php echo $datasheet; ?>" target="_blank">Download datasheet</a>
					<br>
					<a href="<?php echo $handbook; ?>" target="_blank">Download product handbook</a>
				</div>
			</div>
		</div>
	</div>
